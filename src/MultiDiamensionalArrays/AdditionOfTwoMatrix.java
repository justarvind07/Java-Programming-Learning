...
public class AdditionOfTwoMatrix {
    static void printMatrix(int[][] matrix) { // Print matrix method
    ...
    static void add(int[][] a, int r1, int c1, int[][] b, int r2, int c2) { // here i call matrix data and r and c
        if (r1 != r2 || c1 != c2) {
            System.out.println("Addition not possible");
            return;
        }

        int[][] sum = new int[r1][c1]; // taking an matrix where i can store my ans
